VERSION 5.00
Begin VB.Form frmDDFeAPIRetorno 
   ...
   Begin VB.ComboBox comboTpDown 
      Height          =   315
      ItemData        =   "frmDDFeAPIRetorno.frx":0000
      Left            =   120
      List            =   "frmDDFeAPIRetorno.frx":0013
      TabIndex        =   26
      Text            =   "X"
      Top             =   8880
      Width           =   2055
   ...
   End
End
Attribute VB_Name = "frmDDFeAPIRetorno"
...
On Error GoTo SAI
    ...
    result = downloadDDFeAndSave(txtToken.Text, txtChaveRetorno.Text, comboTpDown.Text, txtTpAmb.Text, "C:\Documentos", isShow)
    'result = downloadDDFe(txtToken.Text, txtChaveRetorno.Text, comboTpDown.Text)
    txtResult.Text = result
